...
if CLIENT then
	...
	novmanip = CreateClientConVar("Beatrun_UnarmedBlocksVManip", 1, true, false, "Runner hands blocks VManip actions (or not)", 0, 1)
	...
	hook.Add("VManipPrePlayAnim", "LOCNoVManip", function()
		if (LocalPlayer():GetActiveWeapon():GetClass() == "runnerhands" and novmanip) or blinded then return false end
	end)
end
